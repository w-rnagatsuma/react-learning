...
export default function ContactPage() {
  ...
  const updateField =
    (key: keyof ContactForm) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
          ...
          <form className="flex flex-col gap-4">
            <fieldset className="flex flex-col gap-2">
              ...
              {(errors.lastName || errors.firstName) && (
                <p className="text-sm text-red-600">{errors.lastName || errors.firstName}</p>
              )}
            </fieldset>
            ...
            <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-base whitespace-pre-wrap">{form.message || '-'}</dd>
                </div>
              </dl>
            </div>
